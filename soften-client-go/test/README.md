...
<table>
    ...
    <!-- listen cases -->
    <tr align="left">
        <th rowspan="10">Listen</th></th><th>listen 1msg (Ready)</th><th></th><th>send msg before</th>
    </tr>
    ...
    <tr align="left"><th>listen 3msg from L1(Ready) and L2&S1</th><th></th><th>send msg before</th></tr>
    <!-- before check cases -->
    <tr align="left">
